              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Lihat! </b>Ada kepucatan telapak tangan
                  </CardTitle>
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            name="radio1"
                            value={"sangatPucat"}
                            onChange={handlePucat}
                            checked={anemia_isPucat === "sangatPucat"}
                            required
                          />
                          <span
                            style={{ left: "0px" }}
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={"agakPucat"}
                            onChange={handlePucat}
                            checked={anemia_isPucat === "agakPucat"}
                          />
                          <span
                            style={{ left: "7px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          ...
          <Col sm="4">
            <Button
              ...
              block
            >
              Pemeriksaan HIV <FontAwesomeIcon icon={faChevronRight} />
            </Button>
          </Col>
        </Row>
      </div>
