...
const Batuk = (props) => {
  ...
  let [bsb_jumlahNafas, set_bsb_jumlahNafas] = useState(
    ansBatuk.bsb_jumlahNafas
  );
  let [bsb_nafasCepat, set_bsb_nafasCepat] = useState(ansBatuk.bsb_nafasCepat);
  let [bsb_tarikanDindingDada, set_bsb_tarikanDindingDada] = useState(
    ansBatuk.bsb_tarikanDindingDada
  );
          ...
          <div style={{ minHeight: "455px" }}>
            <Row className="justify-content-center">
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Hitung nafas dalam 1 menit !
                  </CardTitle>
                  <div className="w-100 d-flex justify-content-center">
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Ada tarikan dinding dada dalam
                  </CardTitle>
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={bsb_tarikanDindingDada === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer3}
                            checked={bsb_tarikanDindingDada === false}
                            required
                          />
                          <span
                            style={{ left: "0px" }}
