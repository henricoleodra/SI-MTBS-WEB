    ...
    return(
        <Form onSubmit={handleSubmit}>
            ...
            <Row className="justify-content-between px-5 py-0">
                <Col sm="4">
                    <Link to="TandaBahayaUmum1" style={{textDecoration: "none"}}><Button block style={{width: "250px", height : "60px", backgroundColor : '#fe8d3b'}}><FontAwesomeIcon icon={faChevronLeft}/> Pemeriksaan Tanda Bahaya Umum</Button></Link>
                </Col>
                <Col sm="4">
                    <Button type="submit" block style={{width: "250px", height : "60px", backgroundColor : '#46d0fe'}} >Selanjutnya <FontAwesomeIcon icon={faChevronRight}/></Button>
                </Col>
            </Row>
        </div>
        </Form>
