...
const Demam = (props) => {
  ...
  let [demam_ruamKemerahan, set_demam_ruamKemerahan] = useState(
    ansDemam.demam_ruamKemerahan
  );
    ...
    <Form onSubmit={handleSubmit}>
      <div className="w-100">
              ...
              <Card style={outlineColor} className="text-center w-75">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Lihat! </b>Adanya tanda-tanda Campak saat ini
                  </CardTitle>
                  <hr
                    style={{
                      color: "#46d0fe",
                  ...
                  />
                  <h6>
                    Ruam kemerahan di kulit yang meyeluruh DAN anak mengalami
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={demam_ruamKemerahan === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer1}
                            checked={demam_ruamKemerahan === false}
                          />
                          <span
                            style={{ left: "0px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="Demam2" style={{ textDecoration: "none" }}>
