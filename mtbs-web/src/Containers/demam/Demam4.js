                        ...
                        <FormGroup className="d-inline pr-2">
                          <Label className="rdoBtn">
                            ...
                            <Input
                              type="radio"
                              name="radio1"
                              /**value={1} onChange={handleAnswer1} checked={tbu_letargis === true}**/ required
                            />
                            <span
                              style={{ left: "20px" }}
                              className="checkmark"
                      ...
                      <Col sm="3">
                        <FormGroup className="d-inline">
                          <Label className="rdoBtn">
                            ...
                            <Input
                              type="radio"
                              name="radio1" /**value={2} onChange={handleAnswer1} checked={tbu_letargis === false}**/
                            />
                            <span
                              style={{ left: "0px" }}
                              className="checkmark"
