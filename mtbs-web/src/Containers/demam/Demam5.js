...
const Demam = (props) => {
  ...
  let [demam_isLukaMulut, set_demam_isLukaMulut] = useState(
    ansDemam.demam_isLukaMulut
  );
  let [demam_descLukaMulutLuas, set_demam_descLukaMulutLuas] = useState(
    ansDemam.demam_descLukaMulutLuas
  );
  let [demam_descLukaMulutDalam, set_demam_descLukaMulutDalam] = useState(
    ansDemam.demam_descLukaMulutDalam
  );
  let [demam_nanahDiMata, set_demam_nanahDiMata] = useState(
    ansDemam.demam_nanahDiMata
  );
  let [demam_korneaKeruh, set_demam_korneaKeruh] = useState(
    ansDemam.demam_korneaKeruh
  );
    ...
    <Form onSubmit={handleSubmit}>
      <div className="w-100">
          ...
          <div style={{ minHeight: "475px" }}>
            <Row className="justify-content-around">
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Lihat! </b>Adanya luka di mulut
                  </CardTitle>
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={demam_isLukaMulut === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer1}
                            checked={demam_isLukaMulut === false}
                          />
                          <span
                            style={{ left: "5px" }}
                            className="checkmark"
                  ...
                  <div>
                    <h6
                      hidden={
                        ...
                        demam_isLukaMulut === false
                      }
                    >
                      <b>Lihat dan Amati!</b> Apakah luka luas atau dalam ?(bisa
                      dipilih keduanya)
                    </h6>
                    <Row
                      className="limitCol "
                    ...
                    >
                      ...
                      <Col sm="3">
                        <FormGroup className="d-inline pr-2">
                          <Label style={{ left: "14px" }} className="chckBtn">
                            Dalam
                            <Input
                              type="checkbox"
                              name="checkBox1"
                              ...
                              /**value={1}**/ onChange={handleAnswer2}
                              checked={demam_descLukaMulutLuas === true}
                            />
                            <span
                              style={{ left: "3px" }}
                      ...
                      <Col sm="3">
                        <FormGroup className="d-inline">
                          <Label style={{ left: "-7px" }} className="chckBtn">
                            Luas
                            <Input
                              type="checkbox"
                              name="checkBox1"
                              ...
                              /**  value={2}**/ onChange={handleAnswer3}
                              checked={demam_descLukaMulutDalam === true}
                            />
                            <span
                              style={{ left: "12px" }}
                              className="checkmarkBox"
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Lihat! </b>Adanya nanah di mata
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="3"></Col>
                    <Col sm="3">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={demam_nanahDiMata === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer4}
                            checked={demam_nanahDiMata === false}
                          />
                          <span
                            style={{ left: "5px" }}
                            className="checkmark"
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Lihat! </b>Adanya kekeruhan di kornea
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="3"></Col>
                    <Col sm="3">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={demam_korneaKeruh === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer5}
                            checked={demam_korneaKeruh === false}
                          />
                          <span
                            style={{ left: "5px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="Demam3" style={{ textDecoration: "none" }}>
