...
const Demam = (props) => {
  ...
  let [demam_isTinggiMenerus, set_demam_isTinggiMenerus] = useState(
    ansDemam.demam_isTinggiMenerus
  );
  let [demam_isNyeriUluOrGelisah, set_demam_isNyeriUluOrGelisah] = useState(
    ansDemam.demam_isNyeriUluOrGelisah
  );
  let [demam_isBadanDingin, set_demam_isBadanDingin] = useState(
    ansDemam.demam_isBadanDingin
  );
          ...
          <div style={{ minHeight: "475px" }}>
            <Row className="justify-content-around">
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Apakah demam mendadak tinggi dan terus
                    menerus?
                  </CardTitle>
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={demam_isTinggiMenerus === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer1}
                            checked={demam_isTinggiMenerus === false}
                          />
                          <span
                            style={{ left: "5px" }}
                            className="checkmark"
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Apakah nyeri ulu hati atau gelisah?
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="3"></Col>
                    <Col sm="3">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={demam_isNyeriUluOrGelisah === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer3}
                            checked={demam_isNyeriUluOrGelisah === false}
                          />
                          <span
                            style={{ left: "5px" }}
                            className="checkmark"
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Apakah badan anak dingin?
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="3"></Col>
                    <Col sm="3">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={demam_isBadanDingin === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer4}
                            checked={demam_isBadanDingin === false}
                          />
                          <span
                            style={{ left: "5px" }}
                            className="checkmark"
