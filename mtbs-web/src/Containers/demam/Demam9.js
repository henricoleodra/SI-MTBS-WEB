...
const Demam = (props) => {
  ...
  let [demam_hasilUjiTorniket, set_demam_hasilUjiTorniket] = useState(
    ansDemam.demam_hasilUjiTorniket
  );
    ...
    <Form onSubmit={handleSubmit}>
      <div className="w-100">
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={demam_hasilUjiTorniket === true}
                            required
                          />
                          <span
                            style={{ left: "6px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer1}
                            checked={demam_hasilUjiTorniket === false}
                          />
                          <span
                            style={{ left: "0px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="Demam8" style={{ textDecoration: "none" }}>
