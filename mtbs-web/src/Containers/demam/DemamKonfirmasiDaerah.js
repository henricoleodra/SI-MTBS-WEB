...
const DemamKonfirmasiDaerah = (props) => {
  ...
  let [
    demam_isBerkunjungDaerahEndemis,
    set_demam_isBerkunjungDaerahEndemis,
  ] = useState(ansDemam.demam_isBerkunjungDaerahEndemis);
              ...
              <Card style={outlineColor} className="text-center w-75">
                <CardBody>
                  <CardTitle className="h5">
                    <span className="font-weight-bold">Tanyakan! </span>Apakah
                    anak pernah berpergian ke daerah endemis dalam 2 minggu
                    terakhir ini? Jika "Ya", tentukan jenis tipe endemis dari
                    daerah tersebut
                  </CardTitle>
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn" style={{ left: "10px" }}>
                          ...
                          <Input
                            ...
                            checked={
                              demam_isBerkunjungDaerahEndemis === "Tinggi"
                            }
                            required
                          />
                          <span
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn" style={{ left: "10px" }}>
                          ...
                          <Input
                            ...
                            onChange={handleDaerahEndemis}
                            checked={
                              demam_isBerkunjungDaerahEndemis === "Rendah"
                            }
                          />
                          <span
                            style={{ left: "-1px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn" style={{ left: "10px" }}>
                          ...
                          <Input
                            ...
                            onChange={handleDaerahEndemis}
                            checked={
                              demam_isBerkunjungDaerahEndemis === "Non Endemis"
                            }
                          />
                          <span
                            style={{ left: "-1px" }}
