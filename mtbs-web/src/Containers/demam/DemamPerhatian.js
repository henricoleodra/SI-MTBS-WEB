      ...
      <div className="w-100">
        <div style={{ minHeight: "590px" }}>
          <Row className="justify-content-center">
            <Card
              className="text-center w-75 bg-danger mt-5 shadow-lg border-danger"
            ...
            >
              <CardBody className="d-flex justify-content-center flex-column">
                ...
                <CardText className="h1 text-white font-weight-bold mt-3">
                  Perhatian
                </CardText>
                <CardText className="h3 text-white font-weight-bold">
                  Lakukan Tes Malaria pada Anak!
                </CardText>
              </CardBody>
            </Card>
          </Row>
      ...
      <Row className="justify-content-between px-5 py-0">
        ...
        <Col sm="4">
          <Link to="Demam1" style={{ textDecoration: "none" }}>
            <Button block style={{ backgroundColor: "#46d0fe", border: "0" }}>
