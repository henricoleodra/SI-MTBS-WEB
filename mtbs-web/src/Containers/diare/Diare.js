...
const Diare = (props) => {
  ...
  let [diare_berapaLama, set_diare_berapaLama] = useState(
    ansDiare.diare_berapaLama
  );
  let [diare_tinjaBerdarah, set_diare_tinjaBerdarah] = useState(
    ansDiare.diare_tinjaBerdarah
  );
    ...
    <Form id="formDiare1" className="" onSubmit={handleSubmit}>
      <div className="w-100">
          ...
          <div style={{ minHeight: "475px" }}>
            <Row className="justify-content-center">
              <Card style={outlineColor} className="text-center w-75">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan dan periksa! </b>Sudah berapa lama?
                  </CardTitle>
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Ada darah dalam tinja
                  </CardTitle>
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={diare_tinjaBerdarah === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer2}
                            checked={diare_tinjaBerdarah === false}
                          />
                          <span
                            style={{ left: "0px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="DiareYaTidak" style={{ textDecoration: "none" }}>
