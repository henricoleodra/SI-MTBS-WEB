    ...
    return(
        <Form id="formDiare1" className="" onSubmit={handleSubmit}>
            ...
            <Row className="justify-content-between px-5 py-0">
                <Col sm="4">
                    <Link to="DiareYaTidak" style={{textDecoration: "none"}}><Button style={{backgroundColor: '#fe8d3b', border: '0'}} block><FontAwesomeIcon icon={faChevronLeft}/> Sebelumnya</Button></Link>
                </Col>
                <Col sm="4">
