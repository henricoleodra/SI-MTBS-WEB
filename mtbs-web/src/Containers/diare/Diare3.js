...
const Diare3 = (props) => {
  ...
  let [diare_isNotMinum, set_diare_isNotMinum] = useState(
    ansDiare.diare_isNotMinum
  );
  let [diare_kulitPerutLambat, set_diare_kulitPerutLambat] = useState(
    ansDiare.diare_kulitPerutLambat
  );
    ...
    <Form id="formDiare3" onSubmit={handleSubmit}>
      <div className="w-100">
          ...
          <div style={{ minHeight: "475px" }}>
            <Row className="justify-content-center">
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Beri anak minum
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="7">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn" style={{ fontSize: "18px" }}>
                          Tidak bisa minum / malas minum
                          <Input
                            type="radio"
                            value={1}
                            onChange={handleAnswer1}
                            checked={diare_isNotMinum === true}
                            name="radio1"
                            required
                          />
                          <span
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn" style={{ fontSize: "18px" }}>
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer1}
                            checked={diare_isNotMinum === false}
                            name="radio1"
                            required
                          />
                          <span
                            style={{ top: "1px", left: "-25px" }}
                            className="checkmark"
                          ></span>
                        </Label>
                      </FormGroup>
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Cubit kulit perut, apakah kembalinya :{" "}
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="12">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          <Col sm="11" style={{ left: "-17px" }}>
                            Sangat lambat (lebih dari 2 detik)
                          </Col>
                          <Input
                            value={"SangatLambat"}
                            onChange={handleAnswer2}
                            checked={diare_kulitPerutLambat === "SangatLambat"}
                            type="radio"
                            name="radio2"
                            required
                          />
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={"Lambat"}
                            onChange={handleAnswer2}
                            checked={diare_kulitPerutLambat === "Lambat"}
                          />
                          <span
                            style={{ left: "70px" }}
                            className="checkmark"
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={"Normal"}
                            onChange={handleAnswer2}
                            checked={diare_kulitPerutLambat === "Normal"}
                          />
                          <span
                            style={{ left: "70px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="Diare2" style={{ textDecoration: "none" }}>
          ...
          <Col sm="4">
            <Button type="submit" style={{ backgroundColor: "#46d0fe" }} block>
              {" "}
              Pemeriksaan Demam <FontAwesomeIcon icon={faChevronRight} />
            </Button>
          </Col>
        </Row>
      </div>
