...
const Gizi = (props) => {
  ...
  let [gizi_tampakSangatKurus, set_gizi_tampakSangatKurus] = useState(
    ansGizi.gizi_tampakSangatKurus
  );
  let [
    gizi_pembengkakanKeduaPunggungKakiAtauTangan,
    set_gizi_pembengkakanKeduaPunggungKakiAtauTangan,
  ] = useState(ansGizi.gizi_pembengkakanKeduaPunggungKakiAtauTangan);
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(FlagChange("FLAG_GIZI", 1));
    axios
  ...
  const handleAnswerPembengkakanKeduaPunggungKakiAtauTangan = (event) => {
    if (event.target.value === "1") {
      ...
      dispatch(
        AnsGiziChange("PEMBENGKAKAN_KEDUA_PUNGGUNG_KAKI_ATAU_TANGAN", true)
      );
    } else {
      set_gizi_pembengkakanKeduaPunggungKakiAtauTangan(false);
      dispatch(
        AnsGiziChange("PEMBENGKAKAN_KEDUA_PUNGGUNG_KAKI_ATAU_TANGAN", false)
      );
    }
  };
    ...
    <Form onSubmit={handleSubmit}>
      <div className="w-100">
          ...
          <div style={{ minHeight: "455px" }}>
            <Row className="justify-content-center">
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Lihat! </b>Apakah anak tampak sangat kurus
                  </CardTitle>
                    ...
                    <Col sm="3">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            type="radio"
                            name="gizi_tampakSangatKurus"
                            value="1"
                            onChange={handleAnswerTampakSangatKurus}
                            checked={gizi_tampakSangatKurus === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value="2"
                            onChange={handleAnswerTampakSangatKurus}
                            checked={gizi_tampakSangatKurus === false}
                          />
                          <span
                            style={{ left: "0px" }}
                            className="checkmark"
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Lihat dan raba! </b>Adanya pembengkakan di kedua punggung
                    kaki/tangan
                  </CardTitle>
                  <Row className="limitCol">
                    <Col sm="3"></Col>
                    <Col sm="3">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            type="radio"
                            name="gizi_pembengkakanKeduaPunggungKakiAtauTangan"
                            value={1}
                            onChange={
                              handleAnswerPembengkakanKeduaPunggungKakiAtauTangan
                            }
                            checked={
                              gizi_pembengkakanKeduaPunggungKakiAtauTangan ===
                              true
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="TelingaYaTidak" style={{ textDecoration: "none" }}>
              <Button style={{ backgroundColor: "#fe8d3b", border: "0" }} block>
                <FontAwesomeIcon icon={faChevronLeft} /> Pemeriksaan Telinga
              </Button>
            </Link>
          </Col>
          <Col sm="4">
