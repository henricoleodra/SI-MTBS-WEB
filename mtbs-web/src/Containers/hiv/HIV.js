...
const HIV = (props) => {
  ...
  let [hiv_ibuPernahTes, set_hiv_ibuPernahTes] = useState(
    ansHIV.hiv_ibuPernahTes
  );
    ...
    <Form id="formHIV1" onSubmit={handleSubmit}>
      <div className="w-100">
        <div className="col-12">
          ...
          <div style={{ minHeight: "475px" }}>
            <Row className="justify-content-center pr-0 pl-0">
              <Card
                style={outlineColor}
                className=" text-center pr-0 pl-0 w-75 mt-3"
              >
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Anak sudah pernah tes HIV
                  </CardTitle>
                  ...
                  <div className="d-flex justify-content-around pt-2">
                      ...
                      <div className="w-100 d-flex justify-content-center">
                        <InputGroup className="w-75">
                          ...
                          <Input
                            ...
                            disabled={
                              hiv_pernahTes === null || hiv_pernahTes === false
                            }
                            required
                          />
                        </InputGroup>
                    ...
                    <div className="d-line">
                      <h6 className="pr-5" style={{ left: "-30px" }}>
                        Hasilnya
                      </h6>
                      <Row className="limitCol ">
                        <Col sm="">
                          <FormGroup className="d-inline ">
                            <Label className="rdoBtn" style={{ left: "-30px" }}>
                              Ya
                              <Input
                                type="radio"
                                name="radio2"
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Ibu pernah tes HIV
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="3"></Col>
                    <Col sm="3">
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer4}
                            checked={hiv_ibuPernahTes === false}
                          />
                          <span
                            style={{ left: "0px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="Anemia" style={{ textDecoration: "none" }}>
