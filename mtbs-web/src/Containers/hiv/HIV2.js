...
const HIV2 = (props) => {
  ...
  let [hiv_kerabatTerdiagnosis, set_hiv_kerabatTerdiagnosis] = useState(
    ansHIV.hiv_kerabatTerdiagnosis
  );
  let [hiv_kerabatMeninggal, set_hiv_kerabatMeninggal] = useState(
    ansHIV.hiv_kerabatMeninggal
  );
  let [hiv_masihDapatASI, set_hiv_masihDapatASI] = useState(
    ansHIV.hiv_masihDapatASI
  );
    ...
    <Form onSubmit={handleSubmit}>
      <div className="w-100">
          ...
          <div style={{ minHeight: "475px" }}>
            <Row className="justify-content-center">
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Anak memiliki orang tua kandung dan/atau
                    saudara kandung .....
                  </CardTitle>
                  <hr
                    style={{
                  ...
                  <div className="d-flex flex-column justify-content-center pt-2">
                          ...
                          <FormGroup className="d-inline pr-2">
                            <Label className="rdoBtn">
                              ...
                              <Input
                                ...
                                checked={hiv_kerabatTerdiagnosis === true}
                                required
                              />
                              <span
                                style={{ left: "20px" }}
                          ...
                          <FormGroup className="d-inline">
                            <Label className="rdoBtn">
                              ...
                              <Input
                                ...
                                value={2}
                                onChange={handleAnswer1}
                                checked={hiv_kerabatTerdiagnosis === false}
                              />
                              <span
                                style={{ left: "6px" }}
                                className="checkmark"
                    ...
                    <div className="w-100">
                      <h6>
                        ..... yang meninggal karena penyebab tidak diketahui
                        tapi masih mungkin karena HIV
                      </h6>
                      <Row className="limitCol">
                        <Col sm="3"></Col>
                        <Col sm="3">
                          <FormGroup className="d-inline pr-2">
                            <Label className="rdoBtn">
                              ...
                              <Input
                                ...
                                checked={hiv_kerabatMeninggal === true}
                                required
                              />
                              <span
                                style={{ left: "20px" }}
                          ...
                          <FormGroup className="d-inline">
                            <Label className="rdoBtn">
                              ...
                              <Input
                                ...
                                value={2}
                                onChange={handleAnswer2}
                                checked={hiv_kerabatMeninggal === false}
                              />
                              <span
                                style={{ left: "6px" }}
                                className="checkmark"
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Anak masih mendapatkan ASI
                  </CardTitle>
                  <Row className="limitCol">
                    <Col sm="3"></Col>
                    <Col sm="3">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={hiv_masihDapatASI === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer3}
                            checked={hiv_masihDapatASI === false}
                          />
                          <span
                            style={{ left: "6px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="HIV1" style={{ textDecoration: "none" }}>
