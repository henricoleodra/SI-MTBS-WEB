...
const Imunisasi = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(FlagChange("FLAG_IMUNISASI", 1));
          ...
          <div style={{ minHeight: "520px" }}>
            <Row className="justify-content-center">
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            name="imun_bcg"
                            value={"Belum"}
                            onChange={handleAnswerBCG}
                            checked={imun_bcg === "Belum"}
                            required
                          />
                          <span
                            style={{ left: "30px" }}
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Sudah diberi HB 0
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="4">
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            name="imun_hb0"
                            value={"Belum"}
                            onChange={handleAnswerHB0}
                            checked={imun_hb0 === "Belum"}
                            required
                          />
                          <span
                            style={{ left: "30px" }}
