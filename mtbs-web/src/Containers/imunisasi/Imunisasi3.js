    ...
    return(
        <Form onSubmit={handleSubmit}>
            ...
            <Row className="justify-content-between px-5 py-0">
                <Col sm="4">
                    <Link to="Imunisasi2" style={{textDecoration: "none"}}><Button style={{backgroundColor: '#fe8d3b', border: '0'}} block><FontAwesomeIcon icon={faChevronLeft}/>Sebelumnya</Button></Link>
                </Col>
                <Col sm="4">
