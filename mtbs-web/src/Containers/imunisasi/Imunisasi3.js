...
const Imunisasi3 = (props) => {
  ...
  let [imun_dpthbhib1, set_imun_dpthbhib1] = useState(
    ansImunisasi.imun_dpthbhib1
  );
  let [imun_dpthbhib2, set_imun_dpthbhib2] = useState(
    ansImunisasi.imun_dpthbhib2
  );
  let [imun_dpthbhib3, set_imun_dpthbhib3] = useState(
    ansImunisasi.imun_dpthbhib3
  );
    ...
    <Form onSubmit={handleSubmit}>
      <div className="w-100">
          ...
          <div style={{ minHeight: "520px" }}>
            <Row className="justify-content-center">
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Sudah diberi DPT-HB-Hib 1
                  </CardTitle>
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            name="imun_dpthbhib1"
                            value={"Belum"}
                            onChange={handleAnswerDPTHBBHI1}
                            checked={imun_dpthbhib1 === "Belum"}
                            required
                          />
                          <span
                            style={{ left: "30px" }}
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Sudah diberi DPT-HB-Hib 2
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="4">
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            name="imun_dpthbhib2"
                            value={"Belum"}
                            onChange={handleAnswerDPTHBBHI2}
                            checked={imun_dpthbhib2 === "Belum"}
                            required
                          />
                          <span
                            style={{ left: "30px" }}
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Sudah diberi DPT-HB-Hib 3
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="4">
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            name="imun_dpthbhib3"
                            value={"Belum"}
                            onChange={handleAnswerDPTHBBHI3}
                            checked={imun_dpthbhib3 === "Belum"}
                            required
                          />
                          <span
                            style={{ left: "30px" }}
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="Imunisasi2" style={{ textDecoration: "none" }}>
