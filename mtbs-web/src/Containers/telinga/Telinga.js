...
const Telinga = (props) => {
  ...
  let [telinga_isNyeri, set_telinga_isNyeri] = useState(
    ansTelinga.telinga_isNyeri
  );
  let [telinga_isPenuh, set_telinga_isPenuh] = useState(
    ansTelinga.telinga_isPenuh
  );
  let [telinga_isNanah, set_telinga_isNanah] = useState(
    ansTelinga.telinga_isNanah
  );
  let [telinga_nanahLamaHari, set_telinga_nanahLamaHari] = useState(
    ansTelinga.telinga_nanahLamaHari
  );
          ...
          <div style={{ minHeight: "475px" }}>
            <Row className="justify-content-center">
              <Card style={outlineColor} className="text-center w-75">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Ada nyeri telinga
                  </CardTitle>
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Ada rasa penuh di telinga
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="3"></Col>
                    <Col sm="3">
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Tanyakan! </b>Ada cairan/nanah keluar dari telinga
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="3"></Col>
                    <Col sm="3">
                  ...
                  <div
                    hidden={
                      telinga_isNanah === false || telinga_isNanah === null
                    }
                  >
                    ...
                    <div className="w-100 d-flex justify-content-center">
                      <InputGroup className="w-50">
                        <Input
                          type="number"
                          min="0"
                          value={telinga_nanahLamaHari}
                          onChange={handleAnswer4}
                          disabled={
                            telinga_isNanah === null ||
                            telinga_isNanah === false
                          }
                        />
