...
const Telinga2 = (props) => {
  ...
  let [telinga_cekKeluarNanah, set_telinga_cekKeluarNanah] = useState(
    ansTelinga.telinga_cekKeluarNanah
  );
  let [telinga_isBengkak, set_telinga_isBengkak] = useState(
    ansTelinga.telinga_isBengkak
  );
    ...
    <Form onSubmit={handleSubmit}>
      <div className="w-100">
          ...
          <div style={{ minHeight: "475px" }}>
            <Row className="justify-content-center">
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Lihat! </b>Ada cairan/nanah keluar dari telinga
                  </CardTitle>
                      ...
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={telinga_cekKeluarNanah === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer1}
                            checked={telinga_cekKeluarNanah === false}
                          />
                          <span
                            style={{ left: "0px" }}
                            className="checkmark"
              ...
              <Card style={outlineColor} className="text-center w-75 mt-3">
                <CardBody>
                  <CardTitle className="h5">
                    <b>Raba! </b>Ada pembengkakan yang nyeri di belakang telinga
                  </CardTitle>
                  <Row className="limitCol ">
                    <Col sm="3"></Col>
                    <Col sm="3">
                      <FormGroup className="d-inline pr-2">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            checked={telinga_isBengkak === true}
                            required
                          />
                          <span
                            style={{ left: "20px" }}
                      ...
                      <FormGroup className="d-inline">
                        <Label className="rdoBtn">
                          ...
                          <Input
                            ...
                            value={2}
                            onChange={handleAnswer2}
                            checked={telinga_isBengkak === false}
                          />
                          <span
                            style={{ left: "0px" }}
                            className="checkmark"
        ...
        <Row className="justify-content-between px-5 py-0">
          <Col sm="4">
            <Link to="Telinga1" style={{ textDecoration: "none" }}>
          ...
          <Col sm="4">
            <Button
              ...
              block
            >
              Pemeriksaan Gizi <FontAwesomeIcon icon={faChevronRight} />
            </Button>
          </Col>
        </Row>
      </div>
