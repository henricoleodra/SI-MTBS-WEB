...
const Vitamina = (props) => {
  ...
  let [vit_dibutuhkanA, set_vit_dibutuhkanA] = useState(
    ansVitaminA.vit_dibutuhkanA
  );
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(FlagChange("FLAG_VITAMIN_A", 2));
    dispatch(compStatusChange("KELUHAN_LAIN"));
      ...
      <div className="w-100">
        ...
        <Row className="justify-content-between px-5 py-0">
          ...
          <Col sm="4">
            ...
            >
              Pemeriksaan Keluhan Lain <FontAwesomeIcon icon={faChevronRight} />
            </Button>
          </Col>
        </Row>
      </div>
